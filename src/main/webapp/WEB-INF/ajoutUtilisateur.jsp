	    	...
	    	<div class="col-md-4 col-md-offset-4">
	    		<div class="panel panel-default">
				  	<div class="panel-heading">
				    	<h3 class="panel-title">Ajoutez un utilisateur : <span class="${empty form.erreurs ? 'text-success' : 'text-danger'} text-center">${form.resultat}</span></h3>
				 	</div>
				  	...
				  	<div class="panel-body text-primary">
	                    ...
	                    <fieldset>
				    	  	<div class="form-group">
				    	  		<span>
					    	  		<label for="login">Email: <span class="text-danger">*</span> <span class="text-danger">${form.erreurs.login }</span></label>
